                        ...
                        <div class="wrap-slick2">
                            <div class="slick2">
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-01.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-02.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-03.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-04.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-05.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-06.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-07.jpg') }}" alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                                    ...
                                    <div class="block2">
                                        <div class="block2-pic hov-img0">
                                            <img src="{{ asset('storage/products/product-08.jpg') }}" alt="IMG-PRODUCT">
